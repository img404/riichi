...
The first program was **riichi_score_calculator**, which takes user input about a winning hand and calculates score payments.  

The first iteration uploaded to GitHub took about a week to write. After initially using a naive version tracking system, I am now using SemVar (https://semver.org/) to track updates.
