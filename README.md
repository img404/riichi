...
1. Add a variable at the top for kiriage mangan (a bool that controls whether 4han 30fu & 3han 60fu rounds up to mangan).
2. Add a variable that determines how multiple yakunan are handled, including WRC "yonbaiman" instead of kazoe (counted) yakuman. 
